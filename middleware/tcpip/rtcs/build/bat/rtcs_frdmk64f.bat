...
IF NOT EXIST "%OUTPUTDIR%\." mkdir "%OUTPUTDIR%\."
copy "%ROOTDIR%\rtcs\source\port\fsl_enet_rtcs_adapter.h" "%OUTPUTDIR%\fsl_enet_rtcs_adapter.h" /Y
...
copy "%ROOTDIR%\rtcs\source\include\httpsrv_script.h" "%OUTPUTDIR%\httpsrv_script.h" /Y
